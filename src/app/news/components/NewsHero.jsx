...
export default function NewsHero() {
  return (
    <div className=' relative mt-16 sm:mt-24 xl:mt-28 mx-0 sm:mx-[5%] '>
      <section className="about-hero flex items-center justify-center  text-NormalWhite h-[50vh] sm:h-[55vh] md:h-[60vh] lg:h-[70vh] xl:h-[80vh] pb-[2vh] px-[1.5%]  ">
        <h1 className=" text-[1.3rem] ssm:text-[1.5rem] sm:text-[1.5rem] lg:text-[1.8rem] xl:text-[2rem] leading-[156%] font-bold ">
        News and Insights
        </h1>
      </section>

      <section className='flex gap-4 sm:gap-0 flex-col sm:flex-row pt-4 sm:pt-0 relative sm:absolute top-[85%] justify-between  px-[5%] lg:px-[10%] text-NormalWhite '>
        {Energy.map((energies) => (
           <div className="years-background flex flex-col justify-between  h-[15rem] sm:h-[12rem] md:h-[15rem] lg:h-[17rem] xl:h-[20rem] w-full sm:w-[32%] px-[5%] sm:px-[2%] py-4 " key={energies.key}>
