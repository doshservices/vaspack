...
export default function NewsEnergy() {
  return (
    <div className=' px-[5%] lg:px-[7%] pt-6 sm:pt-40 md:pt-48 lg:pt-52 xl:pt-64 pb-14 '>
        ...
        {NewsEnergyData.map((update) => (
            <div key={update.key} className=' flex flex-col-reverse w-full sm:w-[30%] pt-8 '>
                <div className=' flex flex-row-reverse sm:flex-row justify-between'>
                    <p className=' text-[#666666] text-[0.9rem] ssm:text-base sm:text-[0.6rem] md:text-[0.7rem] lg:text-[0.9rem] xl:text-base font-bold leading-[200%] '>{update.date} </p>
