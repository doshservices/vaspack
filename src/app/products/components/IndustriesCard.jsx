...
export default function IndustriesCard({text, title, background}) {
  return (
    <div className={`${background} px-[4%] py-4 sm:py-7 mb-4 sm:mb-0 flex justify-end gap-7 flex-col h-full text-OtherWhite  text-[0.8rem] ssm:text-[0.85rem] xl:text-[0.9rem] leading-[214%] font-medium text-justify  `}>
      <div>
