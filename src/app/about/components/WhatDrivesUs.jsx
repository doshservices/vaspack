...
export default function WhatDrivesUs() {
  return (
    <div className=" px-[5%] mt-12 lg:mt-16 xl:mt-20 mb-10 lg:mb-12 ">
      <section>
        <div className=" ">
      ...
      <section className=" mt-5 gap-4 sm:gap-0 flex flex-col sm:flex-row justify-between ">
        <div className="mission w-full flex flex-col justify-end  sm:gap-0 sm:block sm:w-[48%] px-[4%] ssm:px-[2%] pt-4 lg:pt-7  pb-4 sm:pb-28 md:pb-40 lg:pb-48 text-OtherWhite ">
