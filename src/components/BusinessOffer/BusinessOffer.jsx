    ...
    <section className={`${background} mt-5 h-[30rem] ssm:h-[32rem] sm:h-[45vh] lg:h-[60vh] xl:h-[70vh] py-4 sm:py-7 px-[4%]  sm:px-[2%] text-OtherWhite flex gap-14 sm:gap-0 flex-col sm:flex-row justify-center sm:justify-between`}>
        <div className=" w-full sm:w-[65%] lg:w-[55%] flex flex-col justify-end gap-6 md:gap-7 ">
          ...
          <div className=" flex justify-between sm:justify-start gap-0 sm:gap-4 md:gap-6 lg:gap-8  text-[0.6rem] ssm:text-[0.7rem] lg:text-[0.8rem] font-semibold leading-[138%] ">
            <div>
                <h3 className=" flex text-[1.1rem] ssm:text-[1.3rem] md:text-[1.5rem] lg:text-[1.7rem] font-semibold leading-[114%] ">~<span><AnimatedCounter start={0} end={60} duration={3} /></span></h3>
            ...
            <div className=" border-NormalWhite border-r-[3px] border-solid "/>
            <div>
                <h3 className="flex text-[1.1rem] ssm:text-[1.3rem] md:text-[1.5rem] lg:text-[1.7rem] font-semibold leading-[114%] ">~<span><AnimatedCounter start={0} end={100} duration={3} /></span>+</h3>
