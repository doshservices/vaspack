...
export default function Footer() {
  return (
    <footer className=" top-border bg-Gray sm:bg-NormalWhite text-FooterBlack ">
      <section className="relative px-[5%] flex flex-col sm:flex-row justify-between text-[0.8rem] ssm:text-[0.9rem] sm:text-[0.6rem] md:text-[0.7rem] lg:text-[0.8rem] xl:text-[0.85rem] font-medium py-4 md:y-6 lg:py-8 ">
